...
pseudo-spectral LES solver for ABL and wind-farm flows.
\rev{The project documents its use in dozens of scientific publications
spanning wind-farm, rough-surface, canopy, urban, and wall-bounded
flows~\cite{lesgo-publications}; recent work continues to use LESGO for
large wind-farm simulations and public datasets~\cite{zhu2025jhtdbwind}.}
Its numerical formulation combines Fourier collocation in the horizontal directions,
...
\rev{Figure~\ref{fig:wf60-velocity} illustrates the interacting turbulent
wakes in the 60-turbine configuration used for our production benchmark.}
