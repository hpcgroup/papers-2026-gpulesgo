...
conditional or infrequent consumer does not execute; \emph{slice} shrinks a
transfer to the subset of the field the host touches; \emph{relocate} ports
the consumer to the GPU and removes the transfer altogether; and
