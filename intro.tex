...
the two placement strategies above, array mirroring and CUDA managed memory,
on LESGO itself, and trace the bottleneck to host--device coupling
points. Guided by this analysis, we analyze all coupling points across the solver,
